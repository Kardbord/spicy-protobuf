...
# Runs `spicyz` with the flags given as second argument and stores the output in
# the variable named by the first argument.
...
# Runs `spicyc` with the flags given as second argument and stores the output in
# the variable named by the first argument.
function(run_spicyc output)
  execute_process(
    COMMAND "${SPICYC}" ${ARGN}
    OUTPUT_VARIABLE output_
    OUTPUT_STRIP_TRAILING_WHITESPACE)
...
function(spicy_plugin_require_version version)
  ...
  if("${SPICY_PLUGIN_VERSION_NUMBER}" LESS "${version_number}")
    message(
      FATAL_ERROR "Package requires at least Spicy plugin version ${version}, "
